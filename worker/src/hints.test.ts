...
describe("hints", () => {
  describe("buildCacheKey", () => {
    it("creates cache key from print date", () => {
      expect(buildCacheKey("2026-01-14")).toBe("hints:v3:2026-01-14")
    })

    it("handles different date formats", () => {
      expect(buildCacheKey("2025-12-31")).toBe("hints:v3:2025-12-31")
      expect(buildCacheKey("2024-01-01")).toBe("hints:v3:2024-01-01")
    })
  })
